(ns propagators.compiler.operators.behavior
  "Compiler-2 behavior operators."
  (:refer-clojure :exclude [* + - /])
  (:require [clojure.core :as core]
            [propagators.infra.cells.value :as value]
            [propagators.compiler.operators.behavior.arithmetic :as compiler-behavior-arithmetic]
            [propagators.compiler.model.closure-value :as closure-value]
            [propagators.compiler.operators.behavior.history :as behavior-history]
            ...
            [propagators.compiler.operators.reducer :as compiler-reducer]
            [propagators.compiler.operators.tms :as compiler-tms]
