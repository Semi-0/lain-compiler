(ns propagators.compiler.tms-behavior
  "Compatibility facade for compiler-2 TMS/behavior operators.

  New code should require propagators.compiler.operators.tms,
  propagators.compiler.operators.behavior, or propagators.compiler.legacy directly."
  (:require [propagators.compiler.operators.behavior :as behavior]
            [propagators.compiler.legacy :as legacy]
            [propagators.compiler.operators.tms :as tms]))
