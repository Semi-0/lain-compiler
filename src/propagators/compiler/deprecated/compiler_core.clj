(ns ^:deprecated propagators.compiler.deprecated.compiler-core
  "Archived compiler namespace shim; use `propagators.compiler.cps-core`."
  (:require [propagators.compiler.cps-core :as cps]))
