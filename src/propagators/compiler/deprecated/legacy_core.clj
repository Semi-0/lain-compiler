(ns ^:deprecated propagators.compiler.deprecated.legacy-core
  "Archived legacy namespace shim; use `propagators.compiler.deprecated.core`
  for the synchronous compiler or `propagators.compiler.cps-core` for
  production compilation."
  (:require [propagators.compiler.deprecated.core :as deprecated]))
