...
```clojure
propagators.runtime.retained-application/p:apply-application
```
...
{:application-installer
 propagators.runtime.application/p:apply-application}
```
...
```text
propagators.compiler-closure-frame-test: 31 pass, 0 fail, 0 error
propagators.infra.compile-2-test: 431 pass, 0 fail, 0 error
propagators.compiler-gur-linked-list-test: 4 pass, 0 fail, 0 error
```
