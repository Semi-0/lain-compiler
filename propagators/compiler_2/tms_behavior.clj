(ns propagators.compiler-2.tms-behavior
  "Compiler-2 TMS/behavior operator environment.

  Distributed TMS is the normal compiler-2 path here. Central reducer-cell TMS
  bindings are kept only as legacy compatibility."
...
(defn behavior-tms-env []
  (-> (obj/empty-compound-object)
      ...
      (bind-distributed-tms-operators)
