(ns propagators.compiler-2.compiler.declarations
  ...
  (:require [propagators.cells.value :as value]
            ...
            [propagators.compiler-2.lowering.closure-frame :as closure-frame]
            [propagators.compiler-2.model.closure-value :as closure-value]
            [propagators.compiler-2.model.env :as env]
            [propagators.compiler-2.compiler.basis :as h]
            [propagators.compiler-2.lowering.lexical-application :as lexical-application]
            [propagators.compiler-2.model.operator-value :as operator-value]
            [propagators.compiler-2.operators.call-graph :as call-graph]
            [propagators.compiler-2.lowering.retained-application :as retained-application]
